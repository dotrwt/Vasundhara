...
export const EditUser: React.FC = () => {
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          reset({
            ...
            aadhar: formatAadhar(user.aadhar),
            pan: user.pan,
            samagraId: user.samagraId || "",
            kharifCashAccount: user.kharifCashAccount || "",
            kharifKindAccount: user.kharifKindAccount || "",
            rabiCashAccount: user.rabiCashAccount || "",
            rabiKindAccount: user.rabiKindAccount || "",
            jila: user.jila,
            tehsil: user.tehsil,
            gao: user.gao,
  ...
  const submitRecord = async () => {
    ...
    try {
      ...
      if (response.success) {
        toast.success("Farmer registry record updated successfully");
        navigate("/dashboard");
      } else {
      ...
      const errMsg = error.response?.data?.message || "Failed to submit updates. Please check validation.";
      toast.error(errMsg);
    } finally {
      setIsSaving(false);
    }
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  className="block w-full h-11 px-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 dark:focus:border-blue-505 text-sm rounded-md dark:text-white transition-all"
              ...
              <div>
                ...
                <input
                  type="text"
                  maxLength={10}
                  className="block w-full h-11 px-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-808 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 dark:focus:border-blue-505 text-sm rounded-md dark:text-white font-mono uppercase transition-all"
              ...
              <div>
                ...
                />
                {errors.samagraId && (
                  <p className="text-red-665 dark:text-red-450 text-xs font-bold mt-1 uppercase">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="block w-full h-11 px-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-850/10 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 dark:focus:border-blue-505 text-sm rounded-md dark:text-white transition-all"
                ...
                {fields.map((field, index) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <input
                        type="text"
                        className="block w-full h-10 px-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 dark:focus:border-blue-505 text-sm rounded-md dark:text-white transition-all"
                    ...
                    <div className="flex-1">
                      ...
                      <input
                        type="number"
                        step="0.0001"
                        className="block w-full h-10 px-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-808 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-605 dark:focus:border-blue-505 text-sm rounded-md dark:text-white transition-all"
                        placeholder="0.0000"
                    ...
                    {fields.length > 1 && (
                      <div className="flex items-end pt-4 sm:pt-5">
                        <button
                          ...
                          className="h-10 w-10 border border-red-200 dark:border-red-950/30 bg-red-50/50 dark:bg-red-950/20 text-red-600 dark:text-red-400 hover:bg-red-100/50 dark:hover:bg-red-950/40 font-bold uppercase tracking-wider text-xs flex items-center justify-center cursor-pointer rounded-md transition-all shadow-sm"
                        >
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 pt-4 border-t border-gray-200 dark:border-gray-800">
              ...
              >
                ...
                {isSaving ? "Saving Updates..." : "Save Audit Updates"}
              </button>
            </div>
          </div>
        )}
